...
void
port_stats__init(PortStats *message)
{
    static PortStats init_value = PORT_STATS__INIT;
    *message = init_value;
}
size_t
port_stats__get_packed_size(const PortStats *message)
{
...
size_t
port_stats__pack(const PortStats *message, uint8_t *out)
{
    assert(message->base.descriptor == &port_stats__descriptor);
    return protobuf_c_message_pack((const ProtobufCMessage *)message, out);
}
size_t
port_stats__pack_to_buffer(const PortStats *message, ProtobufCBuffer *buffer)
{
    assert(message->base.descriptor == &port_stats__descriptor);
...
PortStats *
port_stats__unpack(ProtobufCAllocator *allocator, size_t len,
                   const uint8_t *data)
{
    return (PortStats *)protobuf_c_message_unpack(&port_stats__descriptor,
                                                  allocator, len, data);
}
void
port_stats__free_unpacked(PortStats *message, ProtobufCAllocator *allocator)
{
    assert(message->base.descriptor == &port_stats__descriptor);
    protobuf_c_message_free_unpacked((ProtobufCMessage *)message, allocator);
}
void
status__init(Status *message)
{
    static Status init_value = STATUS__INIT;
    *message = init_value;
}
size_t
status__get_packed_size(const Status *message)
{
...
size_t
status__pack(const Status *message, uint8_t *out)
{
    assert(message->base.descriptor == &status__descriptor);
    return protobuf_c_message_pack((const ProtobufCMessage *)message, out);
}
size_t
status__pack_to_buffer(const Status *message, ProtobufCBuffer *buffer)
{
    assert(message->base.descriptor == &status__descriptor);
    return protobuf_c_message_pack_to_buffer((const ProtobufCMessage *)message,
                                             buffer);
...
Status *
status__unpack(ProtobufCAllocator *allocator, size_t len, const uint8_t *data)
{
    return (Status *)protobuf_c_message_unpack(&status__descriptor, allocator,
                                               len, data);
}
void
status__free_unpacked(Status *message, ProtobufCAllocator *allocator)
{
    assert(message->base.descriptor == &status__descriptor);
    protobuf_c_message_free_unpacked((ProtobufCMessage *)message, allocator);
}
