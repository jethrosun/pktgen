...
def measure_delay(q, pgen_server, pgen_port, server, out):
    ...
    start_container = "/opt/e2d2/scripts/start-ovs-vm.sh start %d | tee /tmp/start"
    stop_container = "/opt/e2d2/scripts/start-ovs-vm.sh stop"
    stop_container_hard = "/opt/e2d2/scripts/start-ovs-vm.sh hardkill"
